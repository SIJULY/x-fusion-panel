        ...
        with ui.column().classes('w-full flex-grow relative gap-0 overflow-hidden flex flex-col bg-white/80 dark:bg-[#030712]/92 backdrop-blur-xl pointer-events-auto border-t border-white/10 dark:border-[#1e3a5f]/45').style('z-index: 10; contain: content;'):
            ...
            with ui.scroll_area().classes('w-full flex-grow p-4 md:p-6'):
                ...
                with list_header:
                    ...
                    ui.label('内存').classes('flex-[1.5] min-w-[130px] shrink-0 text-center')
                    ui.label('硬盘').classes('flex-[1.5] min-w-[130px] shrink-0 text-center')
                    ui.label('流量').classes('flex-[1.2] min-w-[90px] shrink-0 text-center')
                    ui.label('速率').classes('flex-[1.2] min-w-[90px] shrink-0 text-center')
        ...
        with grid_container:
            if view_mode == 'list':
                with ui.card().classes('status-card w-full p-2 px-4 flex flex-row items-center relative overflow-hidden group hover:bg-white dark:hover:bg-[#070b14]/80 flex-nowrap gap-2').style('contain: content; border-radius: 6px;') as card:
                    ...
                    with ui.column().classes('flex-1 min-w-[70px] shrink-0 text-center items-center justify-center'):
                        tags_list = s.get('tags', [])
                        tags_str = tags_list[0] if tags_list else '--'
                        ui.label(tags_str).classes('text-[11px] text-slate-500 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded truncate max-w-full')

                    with ui.column().classes('flex-[1.2] min-w-[90px] shrink-0 items-center justify-center'):
                        refs['uptime'] = ui.html('--', sanitize=False).classes('text-xs font-mono text-slate-600 dark:text-gray-400 text-center whitespace-nowrap')
                    ...
                    def list_stat_col(width_cls, color_cls, bg_cls):
                        with ui.column().classes(f'{width_cls} shrink-0 px-2 justify-center'):
                            with ui.row().classes('w-full justify-between items-end mb-[2px] flex-nowrap'):
                                ...
                                sub = ui.label('').classes('text-[11px] text-slate-400 truncate text-right')
                    ...
                    refs['cpu_bar'], refs['cpu_pct'], refs['cpu_sub'] = list_stat_col('flex-[1.2] min-w-[100px]', 'bg-blue-500', 'bg-blue-100 dark:bg-gray-700/50')
                    refs['mem_bar'], refs['mem_pct'], refs['mem_sub'] = list_stat_col('flex-[1.5] min-w-[130px]', 'bg-green-500', 'bg-green-100 dark:bg-gray-700/50')
                    refs['disk_bar'], refs['disk_pct'], refs['disk_sub'] = list_stat_col('flex-[1.5] min-w-[130px]', 'bg-purple-500', 'bg-purple-100 dark:bg-gray-700/50')

                    with ui.column().classes('flex-[1.2] min-w-[90px] shrink-0 items-center justify-center font-mono text-xs text-slate-600 dark:text-gray-400 whitespace-nowrap gap-1'):
                        refs['traf_up'] = ui.label('↑ 0B')
                        refs['traf_down'] = ui.label('↓ 0B')

                    with ui.column().classes('flex-[1.2] min-w-[90px] shrink-0 items-center justify-center font-mono text-xs whitespace-nowrap gap-1'):
